<!--
title: 消息快捷操作
id: 6907568031544459266
fullPath: /ukzMukzMukzM/ugDN1YjL4QTN24CO0UjN
updatedAt: 1733810930000
...
启用能力并发布新版本后，具备该应用可用性的用户即可在会话中看到应用的操作。了解如何配置应用可用范围，参考[配置应用可用范围](/ssl:ttdoc/home/introduction-to-scope-and-authorization/availability)。
...
1. 获取 triggerCode
- 通过 [tt.getHostLaunchQuery](/ssl:ttdoc/uYjL24iN/ugzM4UjL4MDO14COzgTN) 获取 triggerCode。
```js 
...
2. 获取内容详情
通过 [tt.getBlockActionSourceDetail](/ssl:ttdoc/getBlockActionSourceDetail) 获取消息的具体内容。
...
3. 内容详情
获取消息内容的接口为 [tt.getBlockActionSourceDetail](/ssl:ttdoc/getBlockActionSourceDetail)，用法与小程序一致，亦可参考下方的完整实例。
