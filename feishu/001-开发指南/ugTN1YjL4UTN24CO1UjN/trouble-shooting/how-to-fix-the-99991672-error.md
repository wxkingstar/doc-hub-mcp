<!--
title: 如何为应用申请所需权限
id: 7168502655055233025
fullPath: /uAjLw4CM/ugTN1YjL4UTN24CO1UjN/trouble-shooting/how-to-fix-the-99991672-error
updatedAt: 1732256575000
...
:::html
<md-alert type="tip">
有些接口只需要开通多个权限中的任一权限即可调用（具体所需权限可参考各 API 文档，例如[发送消息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/create)），按照**最小权限原则**（仅申请开发应用所必需的最小权限集合）申请所需权限，可以帮助管理员快速了解你所申请的权限和场景，加快审批节奏。
</md-alert>
:::
    
### 免审核测试说明

在应用的测试联调阶段，你可以通过以下方式免审核 API 权限进行测试。详细的操作步骤参见[申请 API 权限](/ssl:ttdoc/ukTMukTMukTM/uQjN3QjL0YzN04CN2cDN)。
...
确保测试联调阶段申请的权限符合业务预期后，前往 **应用发布** > **版本管理与发布** 页面，发布应用。商店应用的正式发布分为定向上架、全量上架、非公开上架，你需要根据业务实际情况选择发布，详细介绍参见[发布商店应用](/ssl:ttdoc/uMzNwEjLzcDMx4yM3ATM/uYjMyUjL2IjM14iNyITN)。
