...
id: 7168502655055265793
fullPath: /uAjLw4CM/ugTN1YjL4UTN24CO1UjN/trouble-shooting/how-to-fix-99991663-error
updatedAt: 1740984913000
...
:::html
<md-alert type="tip">
飞书开放平台提供了服务端 SDK ，提供了完整的访问凭证（AccessToken）生命周期管理能力，无需开发者自己获取并刷新访问凭证。点击[了解如何使用飞书开放平台服务端 SDK](/ssl:ttdoc/ukTMukTMukTM/uETO1YjLxkTN24SM5UjN)。
</md-alert>
:::

如果你是自行编写代码获取 Token，则可以自行参考 [获取访问凭证](/ssl:ttdoc/ukTMukTMukTM/uMTNz4yM1MjLzUzM#a8683ac2) 提供的方法，再次调用飞书开放平台获取 Tenant Acess Token 的接口，并使用最新的 Tenant Access Token 请求 OpenAPI。
