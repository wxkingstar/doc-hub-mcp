<!--
title: 机器人相关
id: 6907569523178012673
fullPath: /ugTN1YjL4UTN24CO1UjN/uUzN1YjL1cTN24SN3UjN
updatedAt: 1745920715000
...
**(1) 在[普通文本消息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/create)中@人、@所有人:**<br>
...
``` 
**(2) 在[富文本消息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/im-v1/message/create_json#45e0953e)中@人、@所有人:**<br>
...
``` 
**(3) 在[飞书卡片](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/feishu-card-overview)中@人、@所有人:**<br>
可以使用飞书卡片[富文本（Markdown）](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/content-components/rich-text)内容中的 `at` 人标签，标签示意：
...
``` 
**注意：**
-   对于[自定义机器人](/ssl:ttdoc/ukTMukTMukTM/ucTM5YjL3ETO24yNxkjN)，由于不具有通讯录信息的访问权限，只支持使用 `open_id` @指定人，或 @所有人。不支持使用 `user_id`、`email` @指定人。[自建应用与商店应用](/ssl:ttdoc/home/app-types-introduction/self-built-apps-and-store-apps)则没有此限制。你可以[参考此教程](/ssl:ttdoc/home/user-identity-introduction/open-id)，以任意应用身份请求获取用户的`open_id`。
