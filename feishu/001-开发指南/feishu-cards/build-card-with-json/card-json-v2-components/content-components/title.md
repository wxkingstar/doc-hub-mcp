<!--
title: 标题
id: 7453075757222805506
fullPath: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/content-components/title
updatedAt: 1750668964000
...
本文档介绍标题组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[标题](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/content-components/title)。
...
- `lark_md`：支持部分 Markdown 语法的文本内容。详情参考[lark_md 支持的 Markdown 语法](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/content-components/plain-text)</md-td>
    </md-tr>
    <md-tr>
      <md-td>└ content</md-td>
      <md-td>否</md-td>
      <md-td>String</md-td>
      <md-td>卡片主标题内容。要为标题配置多语言，参考[配置卡片多语言](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/configure-multi-language-content)。
...
- `lark_md`：支持部分 Markdown 语法的文本内容。详情参考[lark_md 支持的 Markdown 语法](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/content-components/plain-text)</md-td>
    ...
    <md-tr>
      ...
      <md-td>否</md-td>
      <md-td>String</md-td>
      <md-td>卡片副标题内容。要为标题配置多语言，参考[配置卡片多语言](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/configure-multi-language-content)。
...
查看字段 `icon.token` 的枚举，参考[图标库](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/enumerations-for-icons)。

### 图标颜色枚举

你可通过 `icon.color` 字段设置图标颜色。查看 `color` 枚举，参考[颜色枚举值](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/enumerations-for-fields-related-to-color)。
