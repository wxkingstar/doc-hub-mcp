<!--
title: 表格
id: 7453076566151643164
fullPath: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/content-components/table
updatedAt: 1758769359000
...
本文档介绍表格组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[表格](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/content-components/table)。
 ...
 - center：中间对齐
  - bottom：底部对齐
    ...
    <md-tr>
      ...
      <md-td>String</md-td>
      <md-td>
数字（number）类型数据的默认值为 right；
        
其它类型数据的默认值为 left</md-td>
      <md-td>
        列内数据水平对齐方式。可选值：
 - left：左对齐
 - center：居中对齐
