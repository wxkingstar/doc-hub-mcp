<!--
title: 表单容器
id: 7453076566151741468
fullPath: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/containers/form-container
updatedAt: 1749548973000
...
本文档介绍表单容器的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[表单容器](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/containers/form-container)。
...
**注意**：表单容器内必须包含一个用于提交表单的[按钮](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/button)组件。</md-td>
    </md-tr>
   <md-tr>
      <md-td>└ name</md-td>
      <md-td>是</md-td>
