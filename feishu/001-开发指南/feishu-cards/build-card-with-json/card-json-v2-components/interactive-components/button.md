<!--
title: 按钮
id: 7453075757222674434
fullPath: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/button
updatedAt: 1749546606000
...
:::html
<md-alert type="tip">
本文档介绍按钮组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[按钮](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/button)。
</md-alert>
:::
