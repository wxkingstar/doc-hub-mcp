<!--
title: 时间选择器
id: 7453075757222903810
fullPath: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/time-selector
updatedAt: 1749546698000
...
:::html
<md-alert type="tip">
本文档介绍时间选择器组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[时间选择器](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/time-selector)。
</md-alert>
:::
