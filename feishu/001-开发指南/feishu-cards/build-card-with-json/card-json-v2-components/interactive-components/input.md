<!--
title: 输入框
id: 7453076566151708700
fullPath: /uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/input
updatedAt: 1749614979000
...
:::html
<md-alert type="tip">
- 本文档介绍输入框组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[输入框](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/input)。

-  要结合使用输入框组件与[按钮](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/button)组件，你需将输入框组件与按钮组件内嵌于[表单容器](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/containers/form-container)中。
</md-alert>
:::
