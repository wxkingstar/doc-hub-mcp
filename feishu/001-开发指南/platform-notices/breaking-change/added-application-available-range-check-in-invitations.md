...
id: 7428556638087053316
fullPath: /uAjLw4CM/ugTN1YjL4UTN24CO1UjN/breaking-change/added-application-available-range-check-in-invitations
updatedAt: 1729601233000
...
- [v4版本](/ssl:ttdoc/ukTMukTMukTM/ucTO5QjL3kTO04yN5kDN)：`/open-apis/chat/v4/chatter/add`
...
### 解决方案
可在开发者后台中，将校验不通过的用户加入到**可用范围**中，以使其通过校验。配置方式请参考：[配置应用可用范围](/ssl:ttdoc/home/introduction-to-scope-and-authorization/availability)。
