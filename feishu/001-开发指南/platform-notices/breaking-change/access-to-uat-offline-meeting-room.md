...
id: 7345453966796226562
fullPath: /uAjLw4CM/ugTN1YjL4UTN24CO1UjN/breaking-change/access-to-uat-offline-meeting-room
updatedAt: 1710318757000
...
- [查询会议室预定表单](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve_config-form/get)
- [查询会议室预定管理员](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve_config-admin/get)
- [查询禁用状态变更通知](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve_config-disable_inform/get)
- [查询会议室配置](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/scope_config/get)
