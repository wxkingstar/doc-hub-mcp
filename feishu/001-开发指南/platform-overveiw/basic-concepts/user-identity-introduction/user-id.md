<!--
title: 如何选择使用哪种 ID
id: 6976091873958379521
fullPath: /home/user-identity-introduction/user-id
updatedAt: 1694672503000
...
- 明确需要使用用户的租户身份标识，例如在**组织人员管理** 场景中（创建成员/组/角色），可以使用 User ID，其与[通讯录](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/passport-v1/session/usum)业务中的 Member ID 两者含义一样。
