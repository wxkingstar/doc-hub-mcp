<!--
title: 如何获取不同的用户 ID
id: 6976091873958313985
fullPath: /home/user-identity-introduction/open-id
updatedAt: 1737444605000
...
通过调用 [通过手机号或邮箱获取用户 ID](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/batch_get_id) 接口，你可基于 **手机号**/**邮箱** 批量获取三种类型的用户 ID。
...
:::note
如何开通权限，参考 [如何为应用申请所需权限](/ssl:ttdoc/uAjLw4CM/ugTN1YjL4UTN24CO1UjN/trouble-shooting/how-to-fix-the-99991672-error#0acf431b)。
:::
