<!--
title: 文本 + 列表选择器
id: 7312637705938829314
fullPath: /ukTMukTMukTM/uYzM3QjL2MzN04iNzcDN/component-list/combinations/text-option-picker
updatedAt: 1702626975000
...
文本 + 列表选择器组合模块本质是一个内容模块（div），在内容模块中通过 `text` 参数设置文本组件、`extra` 参数设置列表选择器组件。关于内容模块的详细配置说明，可参见[内容模块](/ssl:ttdoc/ukTMukTMukTM/uYzM3QjL2MzN04iNzcDN/component-list/common-components-and-elements#6bdb3f37)。
...
:::note
支持在 JSON 配置中调整内容模块所附加的列表选择器组件参数，此外列表选择器为交互组件，支持配置回传交互，详细说明可参见[列表选择器（selectMenu）](/ssl:ttdoc/ukTMukTMukTM/uIzNwUjLycDM14iM3ATN)。
:::
...
- **选项配置模式**：支持 **配置固定人员列表**、**绑定人员选项组变量** 或 **所在会话人员列表**。
    ...
    - **绑定人员选项组变量** 需要绑定一个人员选项组变量。关于卡片变量的使用说明，参见[配置卡片变量](/ssl:ttdoc/ukTMukTMukTM/ucTNwUjL3UDM14yN1ATN/configure-card-variables)。
