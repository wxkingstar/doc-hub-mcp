<!--
title: 按钮（button）
id: 6907569523177242625
fullPath: /ukTMukTMukTM/uEzNwUjLxcDM14SM3ATN
updatedAt: 1724163378000
...
:::warning
该文档为历史消息卡片文档，已不再维护。了解对应新版文档，参考[按钮](/ssl:ttdoc/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/button)。
:::
## 组件展示
...
按钮作为交互组件，其 JSON 描述均定义在[交互模块](/ssl:ttdoc/ukTMukTMukTM/uYzM3QjL2MzN04iNzcDN/component-list/common-components-and-elements)（`"tag": "action"`）的 `actions` 参数中。按钮组件包含的参数说明如下表。
...
<md-td>Struct</md-td>
<md-td>
按钮中的文本。基于文本组件的数据结构配置文本内容，详情参见[文本组件](/ssl:ttdoc/ukTMukTMukTM/uUzNwUjL1cDM14SN3ATN)。
</md-td>
</md-tr>
...
<md-td>Struct</md-td>
<md-td>
基于 url 元素配置多端跳转链接，详情参见[url 元素](/ssl:ttdoc/ukTMukTMukTM/uYzM3QjL2MzN04iNzcDN/component-list/common-components-and-elements#09a320b3)。该字段与 `url` 字段不可同时设置。
</md-td>
</md-tr>
