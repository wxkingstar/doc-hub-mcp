<!--
title: 小程序宿主环境
id: 6907569742383611906
fullPath: /uYjL24iN/uUDNzUjL1QzM14SN0MTN
updatedAt: 1692947455000
...
:::warning
移动端的一个小程序只存在一个实例，而桌面端的同一个小程序，每个模式下均会存在唯一的实例（桌面端小程序有多种模式，详见 [桌面端小程序运行模式](/ssl:ttdoc/uYjL24iN/uIjNzUjLyYzM14iM2MTN#37991f21)）。
:::
...
更多组件相关的内容可参考 [小程序的组件](/ssl:ttdoc/uYjL24iN/ugTNugTNugTN)。
...
- 更多 API 相关的内容，参见 [小程序的 API](/ssl:ttdoc/uYjL24iN/uADOy4CM4IjLwgjM)。
:::
