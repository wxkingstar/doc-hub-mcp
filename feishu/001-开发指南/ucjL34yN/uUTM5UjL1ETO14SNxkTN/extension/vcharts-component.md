<!--
title: VChart 图表组件
id: 7271088962857091100
fullPath: /uYjL24iN/uUTM5UjL1ETO14SNxkTN/extension/vcharts-component
updatedAt: 1693473704000
...
`@visactor/lark-vchart` 是 VChart 为飞书小程序封装的图表组件库，用于支持飞书小程序上的图表渲染。你可以在飞书小程序内，使用 `npm` 方式引入 `@visactor/lark-vchart`。具体的使用方式可参见 [npm 支持](/ssl:ttdoc/uYjL24iN/uEzMzUjLxMzM14SMzMTN/npm-support)。
