<!--
title: 开始使用（仅字节）
id: 7455604963739271187
fullPath: /uYjL24iN/uYDO3YjL2gzN24iN3cjN/quick-start-bytedance-only
updatedAt: 1753959775000
source: https://open.feishu.cn/document/web-components/uYDO3YjL2gzN24iN3cjN/quick-start-bytedance-only
-->
# 开始使用

:::warning
如果您使用的是旧版云文档组件(组件SDK版本为 h5-js-sdk-x.x.x.js)，[请查看旧版文档](/ssl:ttdoc/uYjL24iN/uYDO3YjL2gzN24iN3cjN/old-docs-component/old-quick-start)。
:::
