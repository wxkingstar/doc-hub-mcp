...
id: 7275218961529176068
fullPath: /uAjLw4CM/ukzMukzMukzM/native-integration/specification-description/cicd/android-cicd
updatedAt: 1696745251000
...
:::html
<md-alert type="tip">
最终产物是否可调试与命令的`variant`指向的`buildType`的`isDebuggable`属性相同，与`variant`名称无关。
</md-alert>
:::
