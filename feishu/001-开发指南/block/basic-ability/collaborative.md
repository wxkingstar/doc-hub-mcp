<!--
title: 数据协同
id: 6989248889123848194
fullPath: /uAjLw4CM/uYjL24iN/block/service/collaborative
updatedAt: 1657878477000
...
具体绑定方式为：在[服务端创建流程](/ssl:ttdoc/uAjLw4CM/uYjL24iN/block/service/create)中，开发者服务端将业务数据发送至开放平台，开放平台返回 blockID，从而开发者服务端可以将业务 id 与 blockID 实现绑定。
:::
...
示例代码如下。详细代码可以参考[Block](/ssl:ttdoc/uAjLw4CM/uYjL24iN/block/block-frame/framework-interface/block)。
...
具体调用接口请参考[更新 BlockEntity](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/block-v2/entity/update)。
...
具体调用接口[Block消息推送](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/block-v2/message/create)。
