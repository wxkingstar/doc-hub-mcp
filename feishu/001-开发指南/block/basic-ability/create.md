<!--
title: 创建 Block
id: 6989248828935782402
fullPath: /uAjLw4CM/uYjL24iN/block/service/create
updatedAt: 1726122655000
...
- [Creator](/ssl:ttdoc/uAjLw4CM/uYjL24iN/block/block-frame/logic-layer/register-creator)  ：结构类似 Block，用于创建 BlockEntity。
- 宿主：渲染 Block 的容器。
...
开发者前端（creator）收集到足够的信息之后，调用开发者服务端的创建接口，开发者服务服务端调用平台所提供的 [创建 BlockEntity](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/block-v2/entity/create) 完成 Block 实例的创建。
...
具体参考[服务端创建接口](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/block-v2/entity/create)。
