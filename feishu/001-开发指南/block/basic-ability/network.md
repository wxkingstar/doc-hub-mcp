<!--
title: 网络
id: 6989248828935471106
fullPath: /uAjLw4CM/uYjL24iN/block/guide/basic-ability/network
updatedAt: 1700812319000
...
`tt.request` 的更多参数和用法参见:[request](/ssl:ttdoc/uAjLw4CM/uYjL24iN/block/api/network/request)。
## 注意事项
...
-   [数据协同](/ssl:ttdoc/uAjLw4CM/uYjL24iN/block/service/collaborative)
-   HTTP 长轮询