...
id: 7509692063405162524
fullPath: /uAjLw4CM/uYjL24iN/docs-add-on/featured-case-studies/cloud-document-button-implements-data-binding-solution
updatedAt: 1748507284000
...
> 文本 Block 支持哪些元素可参考 [TextBlockData](/ssl:ttdoc/uAjLw4CM/uYjL24iN/docs-add-on/05-api-doc/BlockData/textblockdata/textblockdata)，例如：纯文本、@User、@Doc、公式...
  
首先要插入一个文本 Block，可以使用[Block.insertBlock](/ssl:ttdoc/uAjLw4CM/uYjL24iN/docs-add-on/05-api-doc/basic-data-reference---base/Block.insertBlock)或者[Block.appendBlock](/ssl:ttdoc/uAjLw4CM/uYjL24iN/docs-add-on/05-api-doc/basic-data-reference---base/Block.appendBlock)实现。
