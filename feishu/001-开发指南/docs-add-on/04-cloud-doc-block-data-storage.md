<!--
title: 数据存储
id: 7225881256558362627
fullPath: /uAjLw4CM/uYjL24iN/docs-add-on/04-cloud-doc-block-data-storage/04-cloud-doc-block-data-storage
updatedAt: 1686207361000
...
| 存储服务名称    | 文档数据                                                                                 | 互动数据                                                                                 |
| --------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| 对应 API    | [Record](/ssl:ttdoc/uAjLw4CM/uYjL24iN/docs-add-on/05-api-doc/basic-data-reference---base/Record.getRecord)               | [Interaction](/ssl:ttdoc/uAjLw4CM/uYjL24iN/docs-add-on/05-api-doc/basic-data-reference---base/Interaction.getData)          |
| 支持组件类型    | -   正文小组件&其附属视图 - [详见](/ssl:ttdoc/uAjLw4CM/uYjL24iN/docs-add-on/02-cloud-doc-block-noun-explanation) | -   正文小组件&其附属视图 - [详见](/ssl:ttdoc/uAjLw4CM/uYjL24iN/docs-add-on/02-cloud-doc-block-noun-explanation) |
| 数据体积      | 500KB                                                                                | 500KB                                                                                |
| 协同能力      | 支持                                                                                   | 支持                                                                                   |
| 冲突解决能力    | 支持                                                                                   | 支持                                                                                   |
