<!--
title: 打开飞书审批
id: 7469765530704560129
fullPath: /uAjLw4CM/uYjL24iN/applink-protocol/supported-protocol/open-an-approval-page
updatedAt: 1739781909000
...
飞书审批固定使用 Applink 打开小程序协议，有关 AppLink 的详细内容可参考文档[AppLink的结构](/ssl:ttdoc/uYjL24iN/ucjN1UjL3YTN14yN2UTN)。
...
- 审批实例 code 获取方式：调用[批量获取审批实例 ID](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/list)接口获取
