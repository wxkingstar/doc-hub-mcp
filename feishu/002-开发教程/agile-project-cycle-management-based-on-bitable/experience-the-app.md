<!--
title: 步骤三：下载并运行示例代码
id: 7112636765656465410
fullPath: /home/agile-project-cycle-management-based-on-bitable/experience-the-app
...
3. 依赖安装成功后，执行以下命令运行示例代码。
    ...
    示例代码运行时，会依次调用 [教程简介](/ssl:ttdoc/home/agile-project-cycle-management-based-on-bitable/introduction) 中提到的所有接口，你可以在控制台查看调用过程。
