<!--
title: 示例代码介绍
id: 6975811364980867074
fullPath: /home/develop-a-bot-in-5-minutes/configuration
updatedAt: 1699856619000
source: https://open.feishu.cn/document/historical-version/develop-a-bot-in-5-minutes/configuration
-->
# 示例代码介绍
本教程代码完成了 [接收消息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/events/receive) 类型的事件定义和处理逻辑，更多事件类型介绍请参考 [事件列表](/ssl:ttdoc/ukTMukTMukTM/uYDNxYjL2QTM24iN0EjN/event-list)。
...
更多介绍，参考[事件订阅](/ssl:ttdoc/ukTMukTMukTM/uUTNz4SN1MjL1UzM)。
...
### 定义回调事件处理入口
:::note
**说明**：回调事件处理入口即[步骤三：配置事件订阅](/ssl:ttdoc/home/develop-a-bot-in-5-minutes/step-5-configure-event-subscription)中配置的公网请求网址 URL。
...
本教程实现了 [发送消息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/create) 的能力，机器人发送任何类型的消息都可以基于 send 扩展。本教程在接收消息事件处理函数内使用了 `send_text_with_open_id`，实现了接收消息之后立刻回复消息的效果。
```
