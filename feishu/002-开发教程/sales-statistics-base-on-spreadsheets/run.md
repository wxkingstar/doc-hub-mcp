<!--
title: 步骤二：下载并运行示例代码
id: 7111212983665754114
fullPath: /home/sales-statistics-base-on-spreadsheets/run
updatedAt: 1710247243000
...
2. 修改`.env`文件中的 **APP_ID**、**APP_SECRET**、**EMAIL**。
    ...
    **APP_ID**、**APP_SECRET**、**EMAIL** 说明：
    ...
    - **EMAIL** 是指当前用户在对应租户内的邮箱地址。
     ...
     :::html
     <img src="//sf3-cn.feishucdn.com/obj/open-platform-opendoc/7a917228fcf1a80d4199868ca845c2ff_ZoV9tBf98E.png" style="width:50%"/>
	 :::
...
3. 依赖安装成功后，执行以下命令运行示例代码。
	...
	示例代码运行时，会依次调用 [教程简介](/ssl:ttdoc/home/sales-statistics-base-on-spreadsheets/sales-statistics-based-on-sheets) 中提到的所有接口，你可以在控制台查看调用过程。
    
    如下图所示，最终会在控制台打印创建的电子表格链接。
    
    :::html
    <img src="//sf3-cn.feishucdn.com/obj/open-platform-opendoc/d37aa5243d63070d74394ce52f1e73b4_kVDNfTtkbW.png" style="70%"/>
    :::
