<!--
title: 步骤三：创建三方审批定义
id: 7122074496202194972
fullPath: /home/quickly-develop-three-party-approvals/get-access-token
updatedAt: 1690196626000
source: https://open.feishu.cn/document/quickly-develop-three-party-approvals/get-access-token
-->
# 步骤三：创建三方审批定义

审批定义是指审批的名称、图标、描述等基础信息。你可以通过调用[创建三方审批定义](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/external_approval/create)接口，将三方审批系统与飞书开放平台对接，以确保后续可以通过其他审批服务接口实现三方审批系统与飞书的数据交互。
...
3. 完成以下参数配置，并点击 **开始调试**。
    ...
    - **请求体**：示例配置以及参数说明请参见以下JSON 示例代码。
        ...
        - 关于接口完整参数的配置说明，参见[创建三方审批定义](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/external_approval/create)。
