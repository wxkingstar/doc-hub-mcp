<!--
title: 简介
id: 7254822274065874946
fullPath: /home/quickly-build-a-feishu-calendar-schedule/introduction
updatedAt: 1698392868000
...
本教程通过 [API 调试台工具](/ssl:ttdoc/tools-and-resources/api-explorer-guide) 介绍如何使用日历服务的开放 API 在飞书内构建日历日程，调用流程如下。在实际使用过程中，你可以结合企业内三方系统的日程安排，构建匹配的飞书日历日程。例如，为招聘系统创建一个招聘日历，并根据系统内已有的日程数据，构建相匹配的飞书日程。
...
<md-tr>
<md-td>
[查询主日历忙闲信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/freebusy/list)
...
<md-tr>
<md-td>
[添加日程参与人](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-event-attendee/create)
...
:::html
<!-- ### 事件
[日程回复](/ssl:ttdoc/ukTMukTMukTM/uEzNxYjLxcTM24SM3EjN) -->
:::
