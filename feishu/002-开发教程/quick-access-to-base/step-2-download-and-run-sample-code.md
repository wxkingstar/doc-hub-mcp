<!--
title: 步骤二：下载并运行示例代码
id: 7238267026853855233
fullPath: /home/quick-access-to-base/step-2-download-and-run-sample-code
updatedAt: 1753069721000
...
6. （可选）为文件内的 `userAccessToken` 配置参数值。配置后，应用将以用户身份操作用户的数据资源，例如直接在用户的文档目录空间下创建多维表格，且所有者为用户。若未配置则默认以应用身份操作应用的数据资源，用户在未经应用授权时可能无法直接访问（与企业设置有关）。
    ...
    1. 前往 [创建多维表格](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app/create) 文档右侧的 API 调试台。
