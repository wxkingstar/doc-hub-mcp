...
> 提供离线、本地的 Markdown 文档检索能力，可直接接入支持 Model Context Protocol (MCP) 的 IDE、Agent 或调试工具。目前支持**企业微信**和**飞书**，文档更新时间：2026-01-19
...
> 2. 当前文档抓取覆盖至 2026-01-19，如需更细粒度更新时间，请自行运行最新的抓取脚本。
